...
{
#ifdef DEBUG_PRINT
   printf("ImplicitPartStmt(R-IS): %s\n", ATwriteToString(term));
#endif
...
{
#ifdef DEBUG_PRINT
   printf("DeclarationTypeSpec(R): %s\n", ATwriteToString(term));
#endif
 ...
 OFP::DerivedTypeSpec1 DerivedTypeSpec1;
 ...
 if (ATmatch(term, "DeclarationTypeSpec_ITS(<term>)", &IntrinsicTypeSpec1.term)) {
      ...
      if (ofp_traverse_IntrinsicTypeSpec(IntrinsicTypeSpec1.term, &IntrinsicTypeSpec1)) {
         // MATCHED IntrinsicTypeSpec
         DeclarationTypeSpec->setIntrinsicTypeSpec(IntrinsicTypeSpec1.newIntrinsicTypeSpec());
      } else return ATfalse;
...
ATbool ofp_traverse_IntrinsicTypeSpec(ATerm term, OFP::IntrinsicTypeSpec* IntrinsicTypeSpec)
{
 ...
 OFP::KindSelector1 KindSelector1;
 ...
 OFP::KindSelector2 KindSelector2;
 ...
 OFP::KindSelector3 KindSelector3;
...
ATbool ofp_traverse_CharSelector(ATerm term, OFP::CharSelector* CharSelector)
{
 ...
 OFP::TypeParamValue1 TypeParamValue1;
 OFP::Expr2 Expr2;
...
// R427 type-attr-spec
//----------------------------------------------------------------------------------------
rATbool ofp_traverse_TypeAttrSpec(ATerm term, OFP::TypeAttrSpec* TypeAttrSpec)
{
#ifdef DEBUG_PRINT
...
ATbool ofp_traverse_TypeBoundProcedureStmt(ATerm term, OFP::TypeBoundProcedureStmt* TypeBoundProcedureStmt)
{
 ...
 OFP::Label1 Label1;
 OFP::BindingAttrList1 BindingAttrList1;
 ...
 OFP::Label2 Label2;
 OFP::TypeBoundProcDeclList1 TypeBoundProcDeclList1;
 OFP::EOS2 EOS2;
...
{
#ifdef DEBUG_PRINT
   printf("TypeDeclarationStmt(R): %s\n", ATwriteToString(term));
#endif
...
ATbool ofp_traverse_DataStmtSetList(ATerm term, OFP::DataStmtSetList* DataStmtSetList)
{
 ...
 OFP::DataStmtSetList1 DataStmtSetList1;
...
ATbool ofp_traverse_PointerStmt(ATerm term, OFP::PointerStmt* PointerStmt)
{
 ...
 OFP::Label, PointerDeclList, EOS Label, PointerDeclList, EOS;
...
ATbool ofp_traverse_ImplicitStmt(ATerm term, OFP::ImplicitStmt* ImplicitStmt)
{
 ...
 if (ATmatch(term, "ImplicitStmt_NONE(<term>,<term>)", &Label.term, &EOS.term)) {
   ...
   // MATCHED ImplicitStmt_NONE
      ImplicitStmt->setOptionType(OFP::ImplicitStmt::NONE);
...
ATbool ofp_traverse_NamelistEntryList(ATerm term, OFP::NamelistEntryList* NamelistEntryList)
{
 ...
 OFP::NamelistEntryList1 NamelistEntryList1;
 OFP::NamelistEntry1 NamelistEntry1;
...
ATbool ofp_traverse_CommonBlockEntry1(ATerm term, OFP::CommonBlockEntry1* CommonBlockEntry1)
{
 ...
 OFP::CommonBlockName CommonBlockName;
 OFP::CommonBlockObjectList1 CommonBlockObjectList1;
...
ATbool ofp_traverse_Variable(ATerm term, OFP::Variable* Variable)
{
 ...
 char * Variable_val;
 if (ATmatch(term, "Variable(Designator_DR_AMB(DataRef([PartRef(PartName(<str>),None,None)])))", &Variable_val)) {
    // MATCHED Variable
    Variable->setValue(Variable_val);
    return ATtrue;
 }
...
ATbool ofp_traverse_Expr(ATerm term, OFP::Expr* Expr)
{
 ...
 char * Expr_val;
 if (ATmatch(term, "Expr(Primary_D_AMB(Designator_DR_AMB(DataRef([PartRef(PartName(<str>),None,None)]))))", &Expr_val)) {
    // MATCHED Expr
    Expr->setValue(Expr_val);
    return ATtrue;
 }
...
ATbool ofp_traverse_PointerAssignmentStmt(ATerm term, OFP::PointerAssignmentStmt* PointerAssignmentStmt)
{
 ...
 OFP::Label2 Label2;
 OFP::DataPointerObject1 DataPointerObject1;
 OFP::BoundsSpecList BoundsSpecList;
 OFP::DataTarget1 DataTarget1;
 OFP::EOS2 EOS2;
...
ATbool ofp_traverse_TypeGuardStmt(ATerm term, OFP::TypeGuardStmt* TypeGuardStmt)
{
 ...
 OFP::DerivedTypeSpec DerivedTypeSpec;
 OFP::SelectConstructName1 SelectConstructName1;
 OFP::EOS1 EOS1;
 ...
 OFP::TypeSpec TypeSpec;
 OFP::SelectConstructName2 SelectConstructName2;
 OFP::EOS2 EOS2;
...
ATbool ofp_traverse_ConnectSpec(ATerm term, OFP::ConnectSpec* ConnectSpec)
{
 ...
 OFP::DefaultCharExpr1 DefaultCharExpr1;
 ...
 OFP::DefaultCharExpr2 DefaultCharExpr2;
 ...
 OFP::DefaultCharExpr3 DefaultCharExpr3;
 ...
 OFP::DefaultCharExpr4 DefaultCharExpr4;
 ...
 OFP::DefaultCharExpr5 DefaultCharExpr5;
 ...
 OFP::DefaultCharExpr6 DefaultCharExpr6;
 ...
 OFP::DefaultCharExpr7 DefaultCharExpr7;
 ...
 OFP::DefaultCharExpr8 DefaultCharExpr8;
 ...
 OFP::DefaultCharExpr9 DefaultCharExpr9;
 ...
 OFP::DefaultCharExpr10 DefaultCharExpr10;
 ...
 OFP::DefaultCharExpr11 DefaultCharExpr11;
 ...
 OFP::DefaultCharExpr12 DefaultCharExpr12;
...
ATbool ofp_traverse_ReadStmt(ATerm term, OFP::ReadStmt* ReadStmt)
{
 ...
 OFP::InputItemList1 InputItemList1;
 OFP::EOS1 EOS1;
...
ATbool ofp_traverse_InquireSpec(ATerm term, OFP::InquireSpec* InquireSpec)
{
 ...
 OFP::LogicalVariable1 LogicalVariable1;
 ...
 OFP::LogicalVariable2 LogicalVariable2;
 ...
 OFP::LogicalVariable3 LogicalVariable3;
 ...
 OFP::DefaultCharExpr13 DefaultCharExpr13;
 ...
 OFP::DefaultCharExpr14 DefaultCharExpr14;
 ...
 OFP::DefaultCharExpr15 DefaultCharExpr15;
 ...
 OFP::DefaultCharExpr16 DefaultCharExpr16;
 ...
 OFP::DefaultCharExpr17 DefaultCharExpr17;
 ...
 OFP::DefaultCharExpr18 DefaultCharExpr18;
 ...
 OFP::DefaultCharExpr19 DefaultCharExpr19;
 ...
 OFP::DefaultCharExpr20 DefaultCharExpr20;
...
ATbool ofp_traverse_FormatStmt(ATerm term, OFP::FormatStmt* FormatStmt)
{
 ...
 OFP::Label1 Label1;
 OFP::FormatSpecification1 FormatSpecification1;
 OFP::EOS1 EOS1;
...
ATbool ofp_traverse_UseStmt(ATerm term, OFP::UseStmt* UseStmt)
{
 ...
 OFP::Label1 Label1;
 OFP::ModuleNature1 ModuleNature1;
 OFP::ModuleName1 ModuleName1;
...
ATbool ofp_traverse_InterfaceBody(ATerm term, OFP::InterfaceBody* InterfaceBody)
{
 ...
 OFP::SpecificationPart1 SpecificationPart1;
 OFP::EndFunctionStmt EndFunctionStmt;
...
ATbool ofp_traverse_ProcedureStmt(ATerm term, OFP::ProcedureStmt* ProcedureStmt)
{
 ...
 OFP::Label1 Label1;
 OFP::ProcedureNameList1 ProcedureNameList1;
 OFP::EOS1 EOS1;
...
ATbool ofp_traverse_CallStmt(ATerm term, OFP::CallStmt* CallStmt)
{
 ...
 OFP::Label;, ProcedureDesignator, ActualArgSpecList, EOS Label;, ProcedureDesignator, ActualArgSpecList, EOS;
 OFP::Label, ProcedureDesignator;, ActualArgSpecList, EOS Label, ProcedureDesignator;, ActualArgSpecList, EOS;
 OFP::ActualArgSpecList ActualArgSpecList;
 OFP::EOS EOS;
...
ATbool ofp_traverse_Suffix(ATerm term, OFP::Suffix* Suffix)
{
 ...
 OFP::ProcLanguageBindingSpec1 ProcLanguageBindingSpec1;
 OFP::ResultName1 ResultName1;
...
ATbool ofp_traverse_SubroutineStmt(ATerm term, OFP::SubroutineStmt* SubroutineStmt)
{
 ...
 OFP::Label1 Label1;
 OFP::Prefix1 Prefix1;
 OFP::SubroutineName1 SubroutineName1;
